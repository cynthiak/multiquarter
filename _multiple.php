<div class="multiple container">
  ...
  <table class="multiple-table">
    ...
    <tr class="multiple-table-tr-button">
      ...
      <td class="multiple-table-td-button" colspan="4">
        <button class="multiple-table-button multiple-table-button-disabled" disabled>I'm done with EPS. Let me do revenue &raquo;</button>
      </td>
    </tr>
  </table>
  ...
  <div class="multiple-tooltips">
    <div class="multiple-tooltips-eps">
      <div class="multiple-tooltips-tooltip multiple-tooltips-tooltip-show multiple-tooltips-eps-one">Make your EPS estimate for Q1</div>
